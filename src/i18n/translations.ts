...
export const dict = {
  en: {
    ...
    hobbies: {
      ...
      thingsIDontLike: "Things I Don't Like",
      writing: "Writing",
      empty: "Nothing here yet.",
      bio: [
        "Hi, I'm Zeyu Lai (Michael). I'm a sophomore at UC San Diego. I have a stammer I'm still working on.",
        "I have a habit of dragging chatbots into good-natured arguments until I truly (or nearly) understand the concept behind it. I'm also constantly trying to wrap my head around the latest shifts in generative models and robotic architectures. Rather than just reading the theory, my main goal is to get my hands as dirty as possible with actual hardware and code, building alongside and learning from the greatest minds I can find.",
        "I also have what you might call “spiky attention,” or, if we’re being generous, breadth-first thinking. My brain simply refuses to focus on just one thing at a time; for me to even feel like I’m actually working, I need to be juggling several tasks at once. And I love it.",
      ],
      interests: {
        Sudoku: "Sudoku",
        Matcha: "Matcha",
      ...
      dislikes: {
        ...
        CodexPermissions: "Codex permissions you can't change mid-run",
        JargonFirst: "Explanations that open with jargon instead of intuition",
      },
      categories: {
        All: "All",
        Technical: "Technical",
  ...
  zh: {
    ...
    hobbies: {
      ...
      dislikes: {
        ...
        CodexPermissions: "Codex 里中途改不了的权限设置",
        JargonFirst: "上来先堆术语、不讲直觉的解释",
      },
      categories: {
        All: "全部",
        Technical: "技术",
...
export const experienceData: ExperienceItem[] = [
  {
    role: { en: "Robotics Infrastructure Engineer Intern", zh: "机器人基础设施工程实习生" },
    org: {
      en: "CoCo Matrix — Shanghai",
      zh: "CoCo Matrix · 上海",
    },
